IF  EXISTS (SELECT * FROM sys.objects WHERE name = 'uf_tra_GetNextTradingDateOrNoOfDaysforPeriodEnd')
	DROP FUNCTION uf_tra_GetNextTradingDateOrNoOfDaysforPeriodEnd
GO
...
CREATE FUNCTION [dbo].[uf_tra_GetNextTradingDateOrNoOfDaysforPeriodEnd]
(	
...
BEGIN
	...
	DECLARE @nDaysCount_TradingDays INT = 533001 
	DECLARE @nDaysCount_CalendarDays INT = 533002
	...
	SELECT @nTradingDaysCountType = TradingDaysCountTypePE FROM mst_Company WHERE IsImplementing = 1
