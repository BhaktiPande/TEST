...
IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_usr_GetFormTokenStatus')
	DROP PROCEDURE st_usr_GetFormTokenStatus
GO

CREATE PROCEDURE st_usr_GetFormTokenStatus --'admin','6ED9279A-D0BA-4DE1-B323-D6FD93A9DC8A~MONDAY',0,0
	@inp_UserId				INT,
	@inp_FormId				INT,	
...
BEGIN TRY
	...
	SELECT TOP 1 * FROM usr_UserWiseFormTokenList WHERE UserInfoId = @inp_UserId  and FormId=@inp_FormId and TokenName= @inp_TokenName ORDER BY EXPIREON DESC
