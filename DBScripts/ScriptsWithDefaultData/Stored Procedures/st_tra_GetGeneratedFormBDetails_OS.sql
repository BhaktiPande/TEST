IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_tra_GetGeneratedFormBDetails_OS')
DROP PROCEDURE [dbo].[st_tra_GetGeneratedFormBDetails_OS]
GO
SET ANSI_NULLS ON
GO
...
Usage:
EXEC [st_tra_GetGeneratedFormBDetails_OS] 132020,6
-------------------------------------------------------------------------------------------------*/

CREATE PROCEDURE [dbo].[st_tra_GetGeneratedFormBDetails_OS]
