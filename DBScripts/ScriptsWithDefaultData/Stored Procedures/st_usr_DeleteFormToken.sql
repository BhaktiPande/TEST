...
IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_usr_DeleteFromToken')
	DROP PROCEDURE st_usr_DeleteFromToken
GO

CREATE PROCEDURE st_usr_DeleteFromToken --'admin','6ED9279A-D0BA-4DE1-B323-D6FD93A9DC8A~MONDAY',0,0
	@inp_UserId				INT,
	@inp_FormID 			INT,
