...
CREATE PROCEDURE [dbo].[st_com_PopulateGrid]
	...
	@inp_sParam6 NVARCHAR(255),
	@inp_sParam7 NVARCHAR(255),
	@inp_sParam8 NVARCHAR(255),
	@inp_sParam9 NVARCHAR(255),
	@inp_sParam10 NVARCHAR(255),
	@inp_sParam11 NVARCHAR(255),			
	@inp_sParam12 NVARCHAR(255),			
	@inp_sParam13 NVARCHAR(255),			
	@inp_sParam14 NVARCHAR(255),			
	@inp_sParam15 NVARCHAR(255),			
	@inp_sParam16 NVARCHAR(255),			
	@inp_sParam17 NVARCHAR(255),			
	@inp_sParam18 NVARCHAR(255),			
...
BEGIN
	...
	BEGIN
			...
			EXEC @iRetVal = st_tra_PeriodEndDisclosureUsersStatus @inp_iPageSize, @inp_iPageNo, @inp_sSortField, @inp_sSortOrder,
					...
					@inp_sParam17, @out_nReturnValue OUTPUT, @out_nSQLErrCode OUTPUT,@out_sSQLErrMessage OUTPUT
	END
	...
	BEGIN
			...
			EXEC @iRetVal = st_tra_COInitialDisclosureList @inp_iPageSize, @inp_iPageNo, @inp_sSortField, @inp_sSortOrder,
					@inp_sParam1, @inp_sParam2,@inp_sParam3,@inp_sParam4,@inp_sParam5,@inp_sParam6,@inp_sParam7,
					@inp_sParam8,@inp_sParam9,@inp_sParam10,@inp_sParam11,@inp_sParam12,@inp_sParam13,@inp_sParam14,@inp_sParam15,@inp_sParam16,@inp_sParam17,					
					@out_nReturnValue OUTPUT, @out_nSQLErrCode OUTPUT,@out_sSQLErrMessage OUTPUT
	END
	...
	BEGIN
			...
			EXEC @iRetVal = st_tra_ContinuousDisclosureListByCOUpdated @inp_iPageSize, @inp_iPageNo, @inp_sSortField, @inp_sSortOrder,
					...
					@inp_sParam17,@inp_sParam18,@inp_sParam19,@inp_sParam20,@inp_sParam21,@inp_sParam23,
					@out_nReturnValue OUTPUT, @out_nSQLErrCode OUTPUT,@out_sSQLErrMessage OUTPUT
