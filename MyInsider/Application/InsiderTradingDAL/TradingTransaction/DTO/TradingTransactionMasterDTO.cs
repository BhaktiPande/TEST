...
namespace InsiderTradingDAL
{
    ...
    public class TradingTransactionMasterDTO
    {
    ...
    public class TradingTransactionSummaryDTO
    {
    ...
    public class ContinuousDisclosureStatusDTO
    {
        ...
        public int IsRelativeFound { get; set; }
    }

    public class DuplicateTransactionDetailsDTO
    {
