...
namespace PetaPoco
{
	...
	public class Database : IDisposable
	{
		...
		internal void DoPreExecute(IDbCommand cmd)
		{
			...
			else if (CommandTimeout != 0  && CommandTimeout >30)
			{
				cmd.CommandTimeout = CommandTimeout;
			}//Set the command timeout to 90 for all the cases. If set by user then use the CommandTimeOut value set by user.
            else
            {
