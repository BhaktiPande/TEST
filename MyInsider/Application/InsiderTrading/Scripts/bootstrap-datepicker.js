        ...
        place: function () {
            ...
            if (this.o.orientation.x !== 'auto') {
                ...
                if (this.o.orientation.x === 'right') {
                    /*This date picker is overwritten by "AshishBhumkar" in order to get the style of top right control*/
                    var width = this.component.width();
                    var widthParent = this.component.parent().find(".input-date-picker").width();
                    left = left + widthParent - calendarWidth + width + visualPadding + 10;
                    //-----------original js-----------
