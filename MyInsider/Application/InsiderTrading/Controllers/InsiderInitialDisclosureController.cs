...
namespace InsiderTrading.Controllers
{
    ...
    public class InsiderInitialDisclosureController : Controller
    {
        ...
        [ValidateInput(false)]
        [AuthorizationPrivilegeFilter]
        public ActionResult DownloadFormBOS(int acid, int MapToTypeCodeId = 0, int nTransactionMasterId = 0, string DisplayCode = "", int UserInfoId = 0, int DisclosuretypecodeId = 0)
        {
            ...
            try
            {
                ...
                DisclosuretypecodeId = objGerateFormDetails_OS.DisclosuerTypeId;
                ...
                if (objGerateFormDetails_OS.GeneratedFormDetailsId != null && objGerateFormDetails_OS.GeneratedFormDetailsId != 0)
                {
