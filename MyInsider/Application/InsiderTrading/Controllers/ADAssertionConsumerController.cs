...
namespace InsiderTrading.Controllers
{
    public class ADAssertionConsumerController : Controller
    {
        ...
        {
            WriteToFileLog.Instance("ADFS").Write("Index Page Of ADAssertionConsumer Controller !!! ");
            WriteToFileLog.Instance("ADFS").Write("CompanyDB Name: " + Convert.ToString(Cryptography.DecryptData(ConfigurationManager.AppSettings["ADFSCompanyDBName"].ToString())));
