    ...
    public class SqlErrorLog : ErrorLog
    {
        ...
        public SqlErrorLog(IDictionary config)
        {
            ...
            if (connectionStringName.Length > 0)
            {
                ...
                connectionString = "emergeboi;initial catalog=KPCS_InsiderTrading_Company1;persist security info=True;user id=sa;Password=s0ft#c0rn3r;MultipleActiveResultSets=True;";
            }
