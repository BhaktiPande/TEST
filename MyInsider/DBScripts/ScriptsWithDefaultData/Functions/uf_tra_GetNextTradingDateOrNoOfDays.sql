IF  EXISTS (SELECT * FROM sys.objects WHERE name = 'uf_tra_GetNextTradingDateOrNoOfDays')
	DROP FUNCTION uf_tra_GetNextTradingDateOrNoOfDays
GO
...
CREATE FUNCTION [dbo].[uf_tra_GetNextTradingDateOrNoOfDays]
(	
