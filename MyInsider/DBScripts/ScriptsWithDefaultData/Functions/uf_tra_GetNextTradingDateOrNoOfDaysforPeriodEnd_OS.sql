IF  EXISTS (SELECT * FROM sys.objects WHERE name = 'uf_tra_GetNextTradingDateOrNoOfDaysforPeriodEnd_OS')
	DROP FUNCTION uf_tra_GetNextTradingDateOrNoOfDaysforPeriodEnd_OS
GO
...
CREATE FUNCTION [dbo].[uf_tra_GetNextTradingDateOrNoOfDaysforPeriodEnd_OS]
(	
...
BEGIN
	...
	DECLARE @nDaysCount_TradingDays INT = 532001 
	DECLARE @nDaysCount_CalendarDays INT = 532002
	...
	SELECT @nTradingDaysCountType = TradingDaysCountTypePE_OS FROM mst_Company WHERE IsImplementing = 1
