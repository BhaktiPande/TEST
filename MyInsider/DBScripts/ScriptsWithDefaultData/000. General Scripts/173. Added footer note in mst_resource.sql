...
IF NOT EXISTS(SELECT ResourceId FROM mst_Resource 
	...
	BEGIN
		...
		(64004,'dis_lbl_64004','Please upload your De-mat statements (Transactions and Holdings), if any before clicking on the “Confirm” button.','en-us',103303,104002,122112,
