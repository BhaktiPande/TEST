IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_usr_DocumentDetails')
DROP PROCEDURE [dbo].[st_usr_DocumentDetails]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[st_usr_DocumentDetails]
