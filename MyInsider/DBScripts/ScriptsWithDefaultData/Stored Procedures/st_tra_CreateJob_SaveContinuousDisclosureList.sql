...
IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_tra_CreateJob_SaveContinuousDisclosureList')
DROP PROCEDURE [dbo].[st_tra_CreateJob_SaveContinuousDisclosureList]
GO
SET ANSI_NULLS ON
GO
...
/*-------------------------------------------------------------------------------------------------
Description:	This procedure is used to create a job which helps to insert CD records in tra_ContinuousDisc
Returns:		
				
Created by:		Shubhangi
Created on:		23-October-2018
-------------------------------------------------------------------------------------------------*/
--exec st_tra_CreateJob_SaveContinuousDisclosureList 10,Vigilante_Anand2_FormG
CREATE PROCEDURE [dbo].[st_tra_CreateJob_SaveContinuousDisclosureList]
(
...
AS
/****** Object:  Job [KPCSSaveContinuousDisclosureList]    Script Date: 23/10/2018 17:42:03 ******/
DECLARE @sJobName VARCHAR(50)
SET @sJobName = 'KPCSSaveContinuousDisclosureList' + CAST(@inp_nMasterDBCompanyId AS VARCHAR(10)) + '_' + @inp_sCompanyDBName
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@sJobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'This job is created to insert CD records in tra_ContinuousDisc', 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Step 1', 
		...
		@command=N'exec st_tra_SaveContinuousDisclosureList', 
