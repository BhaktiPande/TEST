IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_tra_GetGeneratedFormGDetails_OS')
DROP PROCEDURE [dbo].[st_tra_GetGeneratedFormGDetails_OS]
GO
SET ANSI_NULLS ON
GO
...
GO
/*-------------------------------------------------------------------------------------------------
Description:	This procedure used for getting details for FORM G for  other securities
...
Usage:
EXEC [st_tra_GetGeneratedFormGDetails_OS] 132020,511
-------------------------------------------------------------------------------------------------*/

CREATE PROCEDURE [dbo].[st_tra_GetGeneratedFormGDetails_OS]
...
BEGIN
	...
	DECLARE @ERR_DOCUMENTDETAILS_NOTFOUND INT = 54171 -- Document details does not exist.
	DECLARE @ERR_GetGeneratedFormDetails INT = 54172 -- Error occurred while fetching document details.  
