...
IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_cmu_CreateJob_NotificationQueueGenerator')
DROP PROCEDURE [dbo].[st_cmu_CreateJob_NotificationQueueGenerator]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE st_cmu_CreateJob_NotificationQueueGenerator
(
...
BEGIN
	...
	BEGIN TRY
		...
		EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, 
				...
				EXECUTE @RC = [dbo].[st_cmu_Job_NotificationQueueGenerator] 
				GO', 
