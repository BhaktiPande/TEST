IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_rpt_PeriodEndEmployeeIndividualSummarySSRS')
DROP PROCEDURE [dbo].[st_rpt_PeriodEndEmployeeIndividualSummarySSRS]
GO
SET ANSI_NULLS ON
GO
...
GO
/*-------------------------------------------------------------------------------------------------
Description:	Procedure to List data for Period End Disclosure individual Report 
...
CREATE PROCEDURE [dbo].[st_rpt_PeriodEndEmployeeIndividualSummarySSRS]
		...
		*/
		...
		BEGIN
			...
			BEGIN
				...
				--TUSH
				CREATE TABLE ##TempDetails(rpt_grd_19054 NVARCHAR(200),rpt_grd_19055 NVARCHAR(200),rpt_grd_19056 NVARCHAR(200),rpt_grd_19057 NVARCHAR(200),
				rpt_grd_19058 NVARCHAR(200),rpt_grd_19059  NVARCHAR(200),rpt_grd_19060 NVARCHAR(200),rpt_grd_19061 NVARCHAR(200),UserInfoID INT,
				UserInfoIdRelative NVARCHAR(200),SecurityTypeCodeId NVARCHAR(200),Demat NVARCHAR(200),YearCodeId INT,PeriodCodeId INT)
				
				INSERT INTO ##TempDetails (rpt_grd_19054,rpt_grd_19055,rpt_grd_19056,rpt_grd_19057,
				rpt_grd_19058,rpt_grd_19059,rpt_grd_19060,rpt_grd_19061,UserInfoID,
				UserInfoIdRelative,SecurityTypeCodeId,Demat,YearCodeId,PeriodCodeId)
