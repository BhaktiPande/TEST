IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_tra_CheckPreviousPeriodEndSubmission_OS')
DROP PROCEDURE [dbo].[st_tra_CheckPreviousPeriodEndSubmission_OS]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[st_tra_CheckPreviousPeriodEndSubmission_OS]
	@inp_iUserInfoID										INT,
	@out_nIsPreviousPeriodEndSubmission						INT = 0 OUTPUT,
	@out_sSubsequentPeriodEndOrPreciousPeriodEndResource	NVARCHAR(500) = '' OUTPUT,
	@out_sSubsequentPeriodEndResourceOtherSecurity			NVARCHAR(500) = '' OUTPUT,
...
BEGIN
	...
	DECLARE @ERR_CheckPreviousPeriodEndSubmission INT = 53028 -- Error occurred while check last period end is submitted.
	...
	BEGIN TRY
		...
		DECLARE @nRequiredModuleCodeID INT
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						SET @out_sSubsequentPeriodEndOrPreciousPeriodEndResource = 'dis_msg_53030'
						SET @out_sSubsequentPeriodEndResourceOtherSecurity = 'dis_msg_53144'
					END
				END
		...
		BEGIN
			...
			BEGIN print ' -2'
					SET @out_sSubsequentPeriodEndOrPreciousPeriodEndResource = 'dis_msg_53029'
					SET @out_nIsPreviousPeriodEndSubmission = 0
					SET @out_sSubsequentPeriodEndResourceOtherSecurity = 'dis_msg_53143'
			END
		END
