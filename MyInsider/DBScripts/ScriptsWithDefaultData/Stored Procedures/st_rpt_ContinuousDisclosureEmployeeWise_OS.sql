...
BEGIN
	...
	CREATE TABLE #tmpTransactionDetails(TransactionMasterId INT, TransactionDetailsId INT, 
				...
				ContDisReq INT, Comment INT, LastSubmissionDate DATETIME, CommentId INT, ScpReq INT, HcpReq INT, HcpToExReq INT, Quantity DECIMAL(25,4))
...
INSERT INTO #tmpTransactionDetails(TransactionMasterId, TransactionDetailsId, UserInfoId,
				...
				DetailsSubmissionDate, ScpSubmissionDate, HcpSubmissionDate, InsiderName, ScpReq, HcpReq, HcpToExReq, Quantity)
...
TM.SoftCopyReq, TM.HardCopyReq, StExSubmitDiscloToStExByCOHardcopyFlag, Quantity 
