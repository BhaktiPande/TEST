IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_tra_GetTradingPolicy')
DROP PROCEDURE [dbo].[st_tra_GetTradingPolicy]
GO
SET ANSI_NULLS ON
GO
...
GO
/*-------------------------------------------------------------------------------------------------
Description:	Procedure to get trading policy id for user.
...
CREATE PROCEDURE [dbo].[st_tra_GetTradingPolicy]
AS
