...
IF NOT EXISTS (SELECT CodeID FROM com_Code WHERE CodeID=122101)
BEGIN
	 ...
	 VALUES 
	 (122101,'Personal Details Confirmation',122,'Personal Details Confirmation Setting- Screen',1,1,'110',null,103005,1,GETDATE())
END
