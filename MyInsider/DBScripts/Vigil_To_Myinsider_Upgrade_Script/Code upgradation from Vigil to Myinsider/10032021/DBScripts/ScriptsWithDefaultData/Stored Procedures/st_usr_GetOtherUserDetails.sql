IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_usr_GetOtherUserDetails')
DROP PROCEDURE [dbo].[st_usr_GetOtherUserDetails]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[st_usr_GetOtherUserDetails]
	@SharingBy INT,
