...
IF EXISTS (SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'st_tra_QuantityValueDetails_OS')	
	DROP PROCEDURE st_tra_QuantityValueDetails_OS
GO

CREATE PROCEDURE [dbo].[st_tra_QuantityValueDetails_OS] --251
...
--insert into tra_QuantityValueDetails_OS values(999,999,1,1,'143001','147001',1,GETDATE(),1,GETDATE())
--insert into tra_QuantityValueDetails_OS values(999,999,1,1,'143001','147002',1,GETDATE(),1,GETDATE())
