...
BEGIN
	...
	EXEC st_usr_DMATDetailsSave @inp_iUserInfoId, @inp_iDMATDetailsID, @inp_sDEMATAccountNumber, @inp_sDPBank, @inp_sDPID, @inp_sTMID, 
				@inp_sDescription, @inp_iAccountTypeCodeId, @inp_iLoggedInUserId, @inp_iDPBankCodeId, @out_nReturnValue, @out_nSQLErrCode, @out_sSQLErrMessage
