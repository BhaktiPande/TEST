...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			RETURN @out_nReturnValue
		END
		--Replace "\r\n" with "" for CommunicationModeCodeId Form E(156007) because editor formatting will be used for Contents of Form E(156007)	
		IF(@inp_iCommunicationModeCodeId = 156007)
		BEGIN
